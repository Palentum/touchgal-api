<template>
  <div class="min-h-screen bg-slate-950 text-slate-100">
    <aside class="fixed inset-y-0 left-0 hidden w-64 border-r border-white/10 bg-slate-950/95 p-6 md:block">
      <NuxtLink to="/" class="text-xl font-black">TouchGal Developer</NuxtLink>
    ...
    <div class="md:pl-64">
      <header class="flex items-center justify-between border-b border-white/10 px-6 py-4">
        <NuxtLink to="/" class="md:hidden">TouchGal Developer</NuxtLink>
        <div class="text-sm text-slate-400">脱敏 Galgame API 控制台</div>
