<template>
  <div class="tg-page">
    ...
    <footer class="tg-card-dark" style="border-radius: 0; padding: 64px 0;">
      <div class="tg-container tg-grid-3">
        <div>
          <NuxtLink to="/" class="tg-brand tg-brand-on-dark">
            <img class="tg-logo" src="/logo.webp" width="32" height="32" alt="" aria-hidden="true">
            <span>TouchGal API</span>
          </NuxtLink>
          <p class="tg-muted" style="margin-top: 16px; max-width: 320px;">TouchGal 官方 GalGame 条目信息 API</p>
        </div>
        <div>
          <p class="tg-title-sm" style="color: var(--tg-on-dark);">联系我们</p>
          <div class="tg-muted" style="display: flex; flex-direction: column; align-items: flex-start; gap: 8px; margin-top: 12px;">
            <a href="https://discord.gg/e4QePvPQTB" target="_blank" rel="noreferrer">Discord</a>
          </div>
        </div>
      </div>
    </footer>
