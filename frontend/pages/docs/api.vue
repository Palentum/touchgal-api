...
const sections = [
  ...
  { title: '限流', body: '每个 token 有独立 minute_limit 与 daily_limit，管理员也可以设置账号级全局上限；实际限流取两者较小值。响应头包含 X-RateLimit-Limit-Minute、X-RateLimit-Remaining-Minute、X-RateLimit-Limit-Day、X-RateLimit-Remaining-Day。' },
